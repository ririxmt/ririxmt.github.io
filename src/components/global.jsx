...
const navigation = [
  { name: 'Cybersecurity Bootcamp', href: '/course', current: true },
  { name: 'Cloud Bootcamp', href: '/coursecloud', current: false },
  { name: 'Course Sertifikasi', href: '/coursesertif', current: false },
  { name: 'Sertifikasi Internasional', href: '/global', current: true },
...
const products = [
    {
      ...
      rating: 5,
      reviewCount: 38,
      imageSrc: './src/assets/landing/35.png',
      imageAlt: 'TODO',
      href: '/shop1',
    },
    {
      id: 2,
      name: 'Certified Cybersecurity Awareness Professional (CCAP)',
      price: 'Rp.1.000.000',
      rating: 5,
      reviewCount: 18,
...
export default function Example() {
  return (
      ...
      */}
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <div className="flex items-center justify-between space-x-4">
          <h2 className="text-lg font-medium text-gray-900">Certification Recommendation</h2>
        ...
        <div className="py-10">
          <header>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900">Cybersecurity Beginner</h1>
            </div>
          </header>
          <main>
    ...
    <div className="py-10">
          <header>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900">Cyberseurity Intermediate</h1>
            </div>
          </header>
          <main>
            <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">{/* Your content */}</div>
    ...
    <div className="py-10">
          <header>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900">Cybersecurity Advanced</h1>
            </div>
          </header>
          <main>
            <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">{/* Your content */}</div>
    ...
    <div className="py-10">
          <header>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900">Cybersecurity Professional</h1>
            </div>
          </header>
          <main>
            <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">{/* Your content */}</div>
