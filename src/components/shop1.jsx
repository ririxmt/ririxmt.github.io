...
const product = {
  name: 'Cybersecurity Intoduction',
  version: { name: '1.0', date: 'June 5, 2021', datetime: '2021-06-05' },
  price: 'Rp.1.000.000',
  href: '/bayar',
  description:
    'Introduction to Cyber ​​Security" is basic material that provides an understanding of the principles and practices in protecting information systems from threats that can damage the integrity, confidentiality and availability of data. This material is important for anyone who wants to understand how to protect digital information in the era of information technology which is increasingly advanced.',
  highlights: [
    'EC-Council',
    'CompTIA Security+',
    '',
...
const relatedProducts = [
  ...
  },
  {
    ...
    href: '#',
    price: 'Rp.1.000.000',
    imageSrc: './src/assets/landing/40.png',
    imageAlt:
      'Payment application dashboard screenshot with transaction table, financial highlights, and main clients on colorful purple background.',
  },
  {
    ...
    href: '#',
    price: 'Rp.1.000.000',
    imageSrc: './src/assets/landing/41.png',
    imageAlt:
      'Payment application dashboard screenshot with transaction table, financial highlights, and main clients on colorful purple background.',
  },
  // More products...
...
const footerNavigation = {
  products: [
    ...
    { name: 'Icons', href: '#' },
    { name: 'Course Sertifikasi', href: '#' },
    { name: 'Info Penerimaan', href: '#' },
  ],
  company: [
        ...
        <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          ...
          <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
            ...
            <div className="mt-10 border-t border-gray-200 pt-10">
              <h3 className="text-sm font-medium text-gray-900">Cybersecurity Beginner</h3>
