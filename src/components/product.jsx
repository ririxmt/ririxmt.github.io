...
const currencies = ['IDR', 'USD', 'AUD', 'EUR', 'GBP']
const navigation = {
  pages: [
    { name: 'Home', href: '/' },
    { name: 'Info Penerimaan', href: '/cyber' },
    { name: 'Job Connect', href: '/jobconnect' },
    { name: 'About Pijar', href: '/aboutpijar' },
  ],
  categories: [
    {
      name: 'Bootcamp',
      featured: [
        { name: 'Peneteration Testing', href: '#' },
        { name: 'Bug Bounty', href: '#' },
        { name: 'Blue Team Cybersecurity', href: '#' },
      ],
      collection: [
        { name: '', href: '#' },
        { name: '', href: '#' },
      ...
      categories: [
        { name: 'Alibaba Cloud Engineer', href: '#' },
        { name: 'Google Cloud Engineer', href: '#' },
        { name: 'AWS Cloud Engineer', href: '#' },
        { name: 'Microsoft Azure Engineer', href: '#' },
      ],
      brands: [
    ...
    {
      name: 'Course Sertifikasi',
      featured: [
        { name: 'Red Team Cybersecurity Peneteration Testing (CEH,OWASP,OSCP)', href: '#' },
        { name: 'Blue Team Cybersecurity (CHFI,CSCU,CND,ECIH)', href: '#' },
      ],
      collection: [
      ...
      categories: [
        { name: 'Alibaba Cloud (Associate,Professional,Specialty)', href: '#' },
        { name: 'Google Cloud Engineer (Associate,Professional)', href: '#' },
        { name: 'AWS Cloud Engineer (Associate,Professional)', href: '#' },
        { name: 'Microsoft Azure Engineer (Associate,Professional)', href: '#' },
      ],
      brands: [
        { name: 'Significant Other', href: '#' },
        { name: 'My Way', href: '#' },
...
const offers = [
  { name: 'Download the app', description: '', href: '#' },
  { name: "Return when you're ready", description: '', href: '#' },
  { name: 'Sign up for our newsletter', description: '', href: '#' },
]
const trendingProducts = [
  {
    id: 1,
    name: 'Bootcamp Cybersecurity Defender',
    color: 'Black',
    price: 'Rp.1.000.000',
    href: '#',
    imageSrc: './src/assets/landing/19.png',
  ...
  {
    id: 2,
    name: 'Bootcamp Cybersecurity Penetration Testing',
    color: 'Black',
    price: 'Rp.1.000.000',
    href: '#',
    imageSrc: './src/assets/landing/20.png',
    imageAlt: 'Black machined steel pen with hexagonal grip and small white logo at top.',
    availableColors: [
  ...
  {
    id: 3,
    name: 'Bootcamp Cloud Practiconer AWS',
    color: 'Black',
    price: 'Rp.1.000.000',
    href: '#',
    imageSrc: './src/assets/landing/21.png',
    imageAlt: 'Black machined steel pen with hexagonal grip and small white logo at top.',
    availableColors: [
  ...
  {
    id: 4,
    name: 'Bootcamp Google Cloud Engineer',
    color: 'Black',
    price: 'Rp.1.000.000',
    href: '#',
    imageSrc: './src/assets/landing/22.png',
    imageAlt: 'Black machined steel pen with hexagonal grip and small white logo at top.',
    availableColors: [
...
const collections = [
  {
    name: 'Laravel',
    description: 'Bootcamp Developer WEB dengan LARAVEL ',
    imageSrc: './src/assets/landing/16.png',
    imageAlt: 'Desk with leather desk pad, walnut desk organizer, wireless keyboard and mouse, and porcelain mug.',
    href: '#',
  },
  {
    name: 'Java Script',
    description: 'Bootcamp Developer Java Spring Fundamental',
    imageSrc: './src/assets/landing/17.png',
    imageAlt: 'Wood table with porcelain mug, leather journal, brass pen, leather key ring, and a houseplant.',
    href: '#',
  },
  {
    name: 'Python',
    description: 'Bootcamp Developer Build API dengan Framework Django & PostgreSQL',
    imageSrc: './src/assets/landing/18.png',
...
const testimonials = [
  {
    id: 1,
    quote:
      'Pijar Camp sangat membantu saya dalam menemukan pekerjaan sesuai passion saya di dunia IT dengan mengajarkan base practice dalam memulai sebuah project.',
    attribution: 'Hilmi Khoirulloh',
  },
  {
    id: 2,
    quote:
      'Melalui pembelajaran yang mudah, Pijar Camp memberikan impact yang sangat besar mulai dari network, economy, dan skill saya semakin melebar.',
    attribution: 'Aqil Ghifari',
  },
  {
    id: 3,
    quote:
      'Meskipun saya bukan dari jurusan terkait IT, namun saya bisa membuktikan bahwa menjadi programmer itu tidak melihat asal kita dari jurusan apa atau sekolah dimana.',
    attribution: 'Fikri Haikal',
  },
]
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:grid lg:grid-cols-2 lg:px-8">
                <div className="mx-auto max-w-2xl py-24 lg:max-w-none lg:py-64">
                  <div className="lg:pr-16">
                    ...
                    Belajar menjadi Cybersecurity Engineer dalam 13 Minggu dengan mentor profesional, kurikulum ter-update, kesempatan kerja di 270+ perusahaan.
                    </p>
                    <div className="mt-6">
                      <a
                        href="#"
