...
const navigation = {
  ...
  pages: [
    { name: 'Cybersecurity Bootcamp', href: '/course' },
    { name: 'Cloud Bootcamp', href: '/coursecloud' },
    { name: 'Course Sertifikasi', href: '/coursesertif' },
    { name: 'Info Penerimaan', href: '/infopenerimaan' },
    { name: 'Job Connect', href: '/job' },
...
const paymentMethods = [
  ...
  { id: 'etransfer', title: 'BCA' },
  { id: 'etransfer', title: 'Mandiri' },
  { id: 'etransfer', title: 'BNI' },
]
              ...
              <div className="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                ...
                <dl className="space-y-6 border-t border-gray-200 px-4 py-6 sm:px-6">
                  <div className="flex items-center justify-between">
                    ...
                    <dd className="text-sm font-medium text-gray-900">Rp.1.000.000</dd>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                    ...
                    <dd className="text-base font-medium text-gray-900">Rp.1.010.000</dd>
                  </div>
                </dl>
