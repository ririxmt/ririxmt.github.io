    ...
    <>
      ...
      */}
      ...
      <div className="px-4 py-5 sm:p-6">
        <h3 className="text-base font-semibold leading-6 text-gray-900">My EXP</h3>
        <div className="mt-5">
          <div className="rounded-md bg-gray-50 px-6 py-5 sm:flex sm:justify-between">
            <h4 className="sr-only">EXP</h4>
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 sm:ml-4 sm:mt-0">
                ...
                <div className="mt-1 text-sm text-gray-600 sm:flex sm:items-center">
                  ...
                  <div className="mt-1 sm:mt-0">Last updated on 10 September 2024</div>
                </div>
              </div>
            </div>
