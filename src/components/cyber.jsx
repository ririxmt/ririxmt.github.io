...
const timeline = [
  {
    name: 'Pendaftaran',
    description:
      'Daftar program pelatihan Pijar Campdisini. Setelah itu kamu akan tergabung ke grup Telegram Pijar Camp untuk diberikan soal seleksi yang wajib dikerjakan dalam waktu yang ditentukan.',
    date: 'Tahap Peratama',
    dateTime: '',
  },
  {
    name: 'Seleksi dan Pembayaran',
    description:
  ...
  {
    name: 'Pelatihan Hard Skill & Soft Skill',
    description:
      'Setelah menyetujui syarat dan ketentuan dari Pijar Camp, kamu akan mengikuti pelatihan sesuai dengan waktu dan kurikulum yang telah ditentukan. Selain itu, kamu juga akan mendapatkan kelas persiapan untuk memasuki dunia kerja.',
    date: 'Tahap Ketiga',
    dateTime: '2022-02',
  },
  {
    name: 'Penyelesaian dan Sertifikasi',
    description:
      'Setelah menyelesaikan pelatihan, kamu akan mengerjakan post test untuk menilai kemampuanmu, menyusun CV, dan membuat portofolio. Nantinya di akhir bootcamp kamu akan mendapatkan sertifikat dari Pijar Camp. Jika kamu mampu mendapatkan nilai diatas 75 atau B, kamu akan mendapatkan tambahan sertifikat kompetensi dari Pijar Camp. Nilai 75 atau B ini didapatkan dari gabungan nilai minggu pertama hingga terakhir.',
    date: 'Tahap Keempat',
    dateTime: '2022-12',
  },
]
const jobOpenings = [
  {
    id: 1,
    role: 'Upfront, Cash 100%',
    href: '#',
    description:
      'Bayar Sekarang, Mulai Petualangan Belajarmu.',
    salary: '',
    location: '',
  },
  {
    id: 2,
    role: 'Program Cicilan Regular',
    href: '#',
    description:
      'Pembayaran secara berkala dan tentukan periode pembayaran sesuai pilihanmu.',
    salary: '',
    location: '',
  },
  {
    id: 3,
    role: 'Program Study Now, Pay Later (SNPL)*',
    href: '#',
    description:
      'Belajar dulu, bayar bulanan lebih ringan di 3 bulan pertama.',
    salary: '',
    location: '',
  },
  {
    id: 4,
    role: 'Konsultasi Pembayaran',
    href: '#',
    description:
      'Informasi lebih lanjut mengenai pembayaran, hubungi kami disini.',
    salary: '',
    location: '',
  },
]
        ...
        <div className="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-indigo-100/20 pt-14">
          ...
          <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              ...
              <img
                src="./src/assets/landing/25.png"
                alt=""
                className="mt-0 aspect-[6/5] w-full max-w-lg rounded-2xl object-cover sm:mt-16 lg:mt-0 lg:max-w-none xl:row-span-2 xl:row-end-2 xl:mt-10"
              />
            </div>
          </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
            <div className="w-full lg:max-w-lg lg:flex-auto">
              ...
              Kami menyediakan pembayaran yang fleksibel untuk perjalanan belajarmu yang lebih mudah dan terjangkau. Wujudkan Impianmu bersama Pijar Camp!
              </p>
              <img
